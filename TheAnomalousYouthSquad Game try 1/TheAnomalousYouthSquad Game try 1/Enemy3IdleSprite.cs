...
namespace TheAnomalousYouthSquad_Game_try_1
{
    class Enemy3IdleSprite
    {
        ...
        public Enemy3IdleSprite(Texture2D img, Point size, int frames, int rows, int cls, int msPerFrame)
        {
            picture = img;
            frameSize = size;
            numFrames = frames;
        ...
        {
            spriteBatch.Draw(picture, new Rectangle(1550, 150, 350, 600), new Rectangle(currentFrame.X, currentFrame.Y
