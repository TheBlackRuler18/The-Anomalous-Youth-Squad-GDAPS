...
namespace TheAnomalousYouthSquad_Game_try_1
{
    class NerdIdleSprite
    {
        ...
        public NerdIdleSprite(Texture2D img, Point size, int frames, int rows, int cls, int msPerFrame)
        {
            picture = img;
            frameSize = size;
            numFrames = frames;
        ...
        {
            spriteBatch.Draw(picture, new Rectangle(450, 465, 240, 280), new Rectangle(currentFrame.X, currentFrame.Y
