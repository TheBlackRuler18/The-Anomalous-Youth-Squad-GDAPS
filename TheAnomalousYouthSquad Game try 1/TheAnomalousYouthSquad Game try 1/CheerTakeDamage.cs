...
namespace TheAnomalousYouthSquad_Game_try_1
{
    class CheerTakeDamage
    {
        ...
        public CheerTakeDamage(Texture2D img, Point size, int frames, int rows, int cls, int msPerFrame)
        {
            picture = img;
            frameSize = size;
            numFrames = frames;
        ...
        {
            spriteBatch.Draw(picture, new Rectangle(260, 385, 180, 360), new Rectangle(currentFrame.X, currentFrame.Y
